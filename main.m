...
tic
    ...
    KeyImage = Key(M,N,KeyDecimal,KeyFeature);
    EncImg=Encryption1(PlainImg,KeyImage,KeyDecimal,KeyFeature,M,N);
tEnc=toc;
...
tic
    ...
    KeyFeature = ExtractKeyFeature(KeyDecimal);
    KeyImage = Key(M,N,KeyDecimal,KeyFeature);
    DecImg=Decryption1(EncImg,KeyImage,KeyDecimal,KeyFeature,M,N);
tDec=toc;
fprintf('\nDecryption Time = %f',tDec);   
% figure;
% imshow(uint8(PlainImg));
% figure;
% imshow(uint8(EncImg));
% figure;
% imshow(uint8(DecImg));
...
KeyImage1bit = Key(M,N,KeyDecimal1bit,KeyFeature1bit);
EncImg1bit=Encryption1(PlainImg1bit,KeyImage1bit,KeyDecimal1bit,KeyFeature1bit,M,N);
DecImg1bit=Decryption1(EncImg1bit,KeyImage1bit,KeyDecimal1bit,KeyFeature1bit,M,N);
...
KeyImage2bit = Key(M,N,KeyDecimal2bit,KeyFeature2bit);
EncImg2bit=Encryption1(PlainImg2bit,KeyImage2bit,KeyDecimal2bit,KeyFeature2bit,M,N);
DecImg2bit=Decryption1(EncImg2bit,KeyImage2bit,KeyDecimal2bit,KeyFeature2bit,M,N);
...
EncImgCrop=EncImg;
if Crop==2 
     EncImgCrop(1:128, 1:384)=0;
        EncImgCrop(385:512, 129:384)=0;
        EncImgCrop(257:384, 257:512)=0;
        EncImgCrop(129:256, 257:384)=0;
%           EncImgCrop(1:256, 1:512)=0;
elseif Crop==4
%     EncImgCrop(1:256, 1:256)=0;
    EncImgCrop(1:128, 1:128)=0;
    EncImgCrop(385:512, 385:512)=0;
    EncImgCrop(257:384, 1:128)=0;
    EncImgCrop(129:256, 257:384)=0;
elseif Crop==16
       EncImgCrop(1:128, 1:128)=0;
        
end
DecImgCrop=Decryption1(EncImgCrop,KeyImage,KeyDecimal,KeyFeature,M,N);
...
DecImgNoise=Decryption1(EncImgNoise,KeyImage,KeyDecimal,KeyFeature,M,N);
...
% figure;
% imshow(uint8(DecImgCrop));
% figure;
% imshow(uint8(EncImgNoise));
% figure;
% imshow(uint8(DecImgNoise));